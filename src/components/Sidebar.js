...
import usericon from "../static/img/user.jpg"
            ...
            <section>
                <aside id="leftsidebar" className="sidebar">
                    <div className="user-info">
                        <div className="image">
                            <img src={usericon} width="52" height="52" alt="User" />
                        </div>
                        <div className="info-container">
                            ...
                            <div className="email">hmalhotra_be19@thapar.edu</div>
                    ...
                    <div className="legal">
                        <div className="copyright">
                            © 2021 - 2022{" "}
                            <a href="#">Hitesh Malhotra - Nirmal's School Mart</a>.
            </div>
