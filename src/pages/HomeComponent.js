...
class HomeComponent extends React.Component {
    ...
    async fetchHomePage() {
        ...
        this.state.profitChartOption = {
            ...
            title: {
                text: "Total Profit Chart of Products",
            },
            axisX: {
                    ...
                    <div className="row clearfix">
                        ...
                        <div className="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div className="info-box bg-light-green hover-expand-effect">
                                ...
                                <div className="content">
                                    <div className="text">TOTAL PRODUCTS IN STOCK</div>
                                    <div
                                        className="number count-to"
                                        data-from="0"
                                        data-to="243"
                        ...
                        <div className="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div className="info-box bg-orange hover-expand-effect">
                                ...
                                <div className="content">
                                    <div className="text">TOTAL SCHOOL</div>
                                    <div
                                        className="number count-to"
                                        data-from="0"
                                        data-to="1225"
                    ...
                    <div className="row clearfix">
                        ...
                        <div className="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div className="info-box bg-orange hover-expand-effect">
                                ...
                                <div className="content">
                                    <div className="text">PRODUCTS EXPIRE IN WEEK</div>
                                    <div
                                        className="number count-to"
                                        data-from="0"
                                        data-to="1225"
                    ...
                    <div className="row clearfix">
                        ...
                        <div className="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div className="info-box bg-cyan hover-expand-effect">
                                ...
                                <div className="content">
                                    <div className="text">PENDING ORDERS</div>
                                    <div
                                        className="number count-to"
                                        data-from="0"
                                        data-to="257"
